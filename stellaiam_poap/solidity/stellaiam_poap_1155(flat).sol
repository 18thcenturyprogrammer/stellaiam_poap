...
// File: contracts/stellaiam_poap_1155.sol
...
contract Stellaiam_poap is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    event paidPoapClaim(address indexed whoPaid, uint256 indexed claimId , uint256 indexed howMany);
    ...
    function paidByUser(uint256 claimId, uint256 howMany)
        public 
        payable
    {
        require(totalSupply(claimId)+howMany <= maxQtyUserMint,"User mint qty reached max limit");
        require(msg.value == mintFee * howMany ,"Not correct fee");
        emit paidPoapClaim(msg.sender, claimId, howMany);
    }
